...
function FormDepartmentGeneral({ auth, onSuccess, onCancel }) {
  ...
  const fetchData = async () => {
    setIsLoading(true);
    const api = `${process.env.REACT_APP_API_HOST}/api/${process.env.REACT_APP_VERSION}/admin/about-gs/role-and-responsibility/depament-manage-data`;
  ...
  const handleSubmit = async (e) => {
    ...
    swalHelper
      ...
      .then(async (res) => {
        if (res) {
          setIsLoading(true);
          const api = `${process.env.REACT_APP_API_HOST}/api/${process.env.REACT_APP_VERSION}/admin/about-gs/role-and-responsibility/depament-manage-data/${process.env.REACT_APP_API_CREATE}`;
          try {
